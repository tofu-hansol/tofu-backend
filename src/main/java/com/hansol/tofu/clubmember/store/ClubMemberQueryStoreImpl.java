...
import static com.hansol.tofu.club.domain.entity.QClubEntity.clubEntity;
import static com.hansol.tofu.clubmember.domain.entity.QClubMemberEntity.clubMemberEntity;
import static com.hansol.tofu.member.domain.QMemberEntity.memberEntity;
...
public class ClubMemberQueryStoreImpl implements ClubMemberQueryStore {
	...
	public List<ClubMemberEntity> findAllByMemberId(Long memberId) {
		return queryFactory.selectFrom(clubMemberEntity)
			...
			// TODO(Reference): ERROR : with-clause not allowed on fetched associations; use filters
